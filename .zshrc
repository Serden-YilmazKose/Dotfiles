...
plugins=(git sudo zsh-autosuggestions history zsh-syntax-highlighting copyfile zsh-bat command-not-found dirhistory)
...
alias la='ls -lAh'
alias gs='git status'
alias up='sudo pacman -Syu && yay -Syu ; pkill -RTMIN+3 i3blocks'
alias ..='cd ..'
alias grep='grep --color=auto'
alias news='newsboat ; pkill -RTMIN+4 i3blocks ; xdotool type "clear" ; xdotool key Enter'
